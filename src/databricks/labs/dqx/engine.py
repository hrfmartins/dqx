...
class DQEngine(DQEngineBase):
    ...
    def __init__(self, workspace_client: WorkspaceClient, extra_params: ExtraParams | None = None):
        ...
        column_names = extra_params.column_names or {}
        self._column_names = {
            ColumnArguments.ERRORS: column_names.get(ColumnArguments.ERRORS.value, DefaultColumnNames.ERRORS.value),
            ColumnArguments.WARNINGS: column_names.get(
